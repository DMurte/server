ALTER TABLE operator DROP permission_base_definations;
ALTER TABLE operator ADD permission_car set('view', 'update', 'delete') DEFAULT 'view' NULL;
ALTER TABLE operator ADD permission_service set('view', 'update', 'delete') DEFAULT 'view' NULL;
